...
ProgrammingError: (42000, [42000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Cannot open server
 ...
 server.  To enable access, use the Windows Azure Management Portal or run sp_set_firewall_rule on the master
  ...
  It may take up to five minutes for this change to take effect. (40615); [42000] [Microsoft][ODBC Driver 17 for SQL Server]Invalid connection string attribute (0))
